...
namespace SocketIOClient.Messages
{
    public class JSONMessage : Message
    {
        ...
        {
            this.MessageText = SimpleJson.SerializeObject(value);
        }

        public virtual T Message<T>()
        {
            try { return SimpleJson.DeserializeObject<T>(this.MessageText); }
            catch (Exception ex)
            {
		 ...
		 public JSONMessage(object jsonObject):this()
        {
            ...
            this.MessageText = SimpleJson.SerializeObject(jsonObject );
        }
